...
import com.CloudCredits.Talkdesk.Request.SingleChatRequest;
import com.CloudCredits.Talkdesk.Response.ApiResponse;
import com.CloudCredits.Talkdesk.service.ChatService;
import com.CloudCredits.Talkdesk.service.GroupChatRequest;
...
public class ChatController {
	...
	@PostMapping("/single")
	public ResponseEntity<Chat>createChatHandler(@RequestBody SingleChatRequest signleChatRequest, @RequestHeader("Authorization")String jwt) throws UserException{
		User reqUser=userService.findUserProfile(jwt);
		
		Chat chat=chatService.creatChat(reqUser, signleChatRequest.getUserId());
	...
	public ResponseEntity<Chat>addUserToGroupHandler(@PathVariable Integer userId, @PathVariable Integer chatId, @RequestHeader("Authorization")String jwt) throws UserException, ChatException{
		User reqUser=userService.findUserProfile(jwt);
	...
	public ResponseEntity<Chat>removeUserFromGroupHandler(@PathVariable Integer userId, @PathVariable Integer chatId, @RequestHeader("Authorization")String jwt) throws UserException, ChatException{
		User reqUser=userService.findUserProfile(jwt);
